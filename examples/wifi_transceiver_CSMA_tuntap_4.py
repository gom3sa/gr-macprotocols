...
# Title: Wifi Transceiver Csma Tuntap 4
# Generated: Wed Jan 24 13:39:22 2018
##################################################
...
class wifi_transceiver_CSMA_tuntap_4(gr.top_block):
...
def main(top_block_cls=wifi_transceiver_CSMA_tuntap_4, options=None):
