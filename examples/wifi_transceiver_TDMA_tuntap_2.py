...
# Title: Wifi Transceiver Tdma Tuntap 2
# Generated: Tue Jan 23 19:52:40 2018
##################################################
...
class wifi_transceiver_TDMA_tuntap_2(gr.top_block):
...
def main(top_block_cls=wifi_transceiver_TDMA_tuntap_2, options=None):
