...
# Title: Wifi Transceiver Tdma Tuntap 3
# Generated: Tue Jan 23 19:52:47 2018
##################################################
...
class wifi_transceiver_TDMA_tuntap_3(gr.top_block):

    def __init__(self):
        gr.top_block.__init__(self, "Wifi Transceiver Tdma Tuntap 3")
        ...
        self.mac_addr = mac_addr = [0x12,0x34,0x56,0x78,0x90,0xad]
        ...
        self.msg_connect((self.macprotocols_frame_buffer_0, 'frame out'), (self.macprotocols_tdma_0, 'frame from buffer'))
        ...
        self.msg_connect((self.macprotocols_tdma_0, 'frame request'), (self.macprotocols_frame_buffer_0, 'ctrl in'))
...
def main(top_block_cls=wifi_transceiver_TDMA_tuntap_3, options=None):
