...
# Title: Wifi Transceiver Tdma Tuntap 5
# Generated: Wed Jan 24 13:13:49 2018
##################################################
...
class wifi_transceiver_TDMA_tuntap_5(gr.top_block):

    def __init__(self):
        gr.top_block.__init__(self, "Wifi Transceiver Tdma Tuntap 5")
...
def main(top_block_cls=wifi_transceiver_TDMA_tuntap_5, options=None):
