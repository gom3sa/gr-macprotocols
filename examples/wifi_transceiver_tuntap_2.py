...
# Generated: Thu Jan 25 15:57:01 2018
##################################################
...
class wifi_transceiver_tuntap_2(gr.top_block):

    def __init__(self):
        gr.top_block.__init__(self, "Wifi Transceiver Tuntap 2")
...
def main(top_block_cls=wifi_transceiver_tuntap_2, options=None):
