...
# Generated: Tue Jan 23 19:52:54 2018
##################################################
...
class wifi_transceiver_TDMA_tuntap_4(gr.top_block):

    def __init__(self):
        gr.top_block.__init__(self, "Wifi Transceiver Tdma Tuntap 4")
...
def main(top_block_cls=wifi_transceiver_TDMA_tuntap_4, options=None):
