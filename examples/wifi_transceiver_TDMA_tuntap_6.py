...
# Title: Wifi Transceiver Tdma Tuntap 6
# Generated: Wed Jan 24 13:14:20 2018
##################################################
...
class wifi_transceiver_TDMA_tuntap_6(gr.top_block):

    def __init__(self):
        gr.top_block.__init__(self, "Wifi Transceiver Tdma Tuntap 6")
...
def main(top_block_cls=wifi_transceiver_TDMA_tuntap_6, options=None):
