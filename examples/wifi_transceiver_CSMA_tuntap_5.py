...
# Title: Wifi Transceiver Csma Tuntap 5
# Generated: Wed Jan 24 13:39:29 2018
##################################################
...
class wifi_transceiver_CSMA_tuntap_5(gr.top_block):

    def __init__(self):
        gr.top_block.__init__(self, "Wifi Transceiver Csma Tuntap 5")
...
def main(top_block_cls=wifi_transceiver_CSMA_tuntap_5, options=None):
