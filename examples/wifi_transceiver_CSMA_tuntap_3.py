...
class wifi_transceiver_CSMA_tuntap_3(gr.top_block):

    def __init__(self):
        gr.top_block.__init__(self, "Wifi Transceiver Csma Tuntap 3")
...
def main(top_block_cls=wifi_transceiver_CSMA_tuntap_3, options=None):
